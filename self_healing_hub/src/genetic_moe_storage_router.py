...
Routes files to the optimal storage node across the 7-layer mesh and Google Drive VFS
...
class GeneticMoEStorageRouter:
    def __init__(self):
        self.nodes = {
            ...
            "main_mac_host": {"name": "Main Mac Apple M4 Pro Mac Mini Host", "capacity_score": 0.15, "latency_score": 0.99, "cloud_score": 0.20, "edge_score": 0.20, "target_dir": "/Volumes/NAS/Hardware_Tiers/Layer_1_Main_Mac_Host"},
