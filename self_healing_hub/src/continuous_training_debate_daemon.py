...
DEBATE_TOPICS = [
    {
        ...
        "local_thesis": "Local AI Orchestrator: Sharded RPC execution across the 7-layer mesh means models do not need to be duplicated on Mac Host. Keep local Mac disk lean for OS swap safety.",
    ...
    },
    {
        ...
        "genetic_thesis": "Genetic MoE: Sharding balance score 98.2%. Routing prompt eval to Apple M4 Pro Mac Mini and token generation to sharded cluster minimizes TTFT.",
    ...
    },
    {
        ...
        "context": "Simulation must exclusively contain real physical hardware (Apple M4 Pro Mac Mini, Ryzen 7, Pixel TPU, RTX 4090, M2 Ultra), real fiber/5G/satellite plans, and real USB-C PD power links.",
