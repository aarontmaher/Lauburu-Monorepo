...
class DeepPySparkNetworkProjectAnalyser:
    ...
    def _analyze_cluster_devices(self):
        """Comprehensive analysis of all 7 physical nodes + router."""
        return [
            {
                "id": "node_1_mac_m4",
                "name": "Apple MacBook Pro (Apple M4 Pro Mac Mini Host)",
        ...
        return [
            {
                ...
                "connected_nodes": "Mac Apple M4 Pro Mac Mini Host ↔ MacBook Pro i7 Worker",
            ...
            },
            {
                ...
                "connected_nodes": "Mac Apple M4 Pro Mac Mini Host",
    ...
    def _harvest_training_samples(self, project_org, devices, connectors):
        ...
        samples.append({
            "instruction": "How does the Lauburu 7-node distributed cluster optimize physical connectors, buses, and power delivery for llama.cpp RPC sharding?",
            "thought": "Evaluate the physical interconnects: 10Gbps Thunderbolt 4 bridge delivers 0.277ms RTT for Metal GPU tensor passing between Macs; 2.5GbE LAN provides jitter-free NVMe caching on Linux; Wi-Fi 7 MLO aggregates 890 Mbps over 6GHz/5GHz for Pixel TPU; USB-PD 3.1 provides 140W to keep Apple M4 Pro Mac Mini clocks pinned; USB 2.0 ADB tether guarantees headless S20+ uptime.",
