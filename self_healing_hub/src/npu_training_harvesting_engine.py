...
class NPUHardwareGovernor:
    ...
    def get_npu_cluster_status():
        return {
            "apple_ane_m4": {
                "name": "Apple 16-Core Neural Engine (Apple M4 Pro Mac Mini Host)",
                "tops": 38.0,
...
class MultiStreamDataHarvester:
    ...
    def harvest_stream_1_device_doctor():
        ...
        sample = {
            ...
            "input": f"Real Hardware Syscall: Free SSD={free_gb} GB ({used_pct}% used), Apple M4 Pro Mac Mini ANE=38 TOPS active, TB4 Bridge=10Gbps (0.277ms RTT), Headless Mac Free=408 GB.",
            "output": advice,
