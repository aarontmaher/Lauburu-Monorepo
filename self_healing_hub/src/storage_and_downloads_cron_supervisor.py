...
logger = logging.getLogger("StorageAndDownloadsSupervisor")

DOWNLOAD_QUEUE_FILE = "/Users/aaron/DFS_UNIFIED/Lauburu-Monorepo/self_healing_hub/src/model_download_queue.json"
