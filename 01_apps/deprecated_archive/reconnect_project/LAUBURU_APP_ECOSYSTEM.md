...
| `lauburu_nomad_courier` | Nomad Courier Mesh Governor | Mesh & Networking | `/apps/nomad_courier/` | 18802 | 7-Tier network failover, Port 4000 watchdog, RFC 792 Wake-on-LAN resurrector, LoRA action logging | `06_scripts_and_tooling/network/nomad_courier_self_healer.py` |
...
- **7-Tier Network Healing Escalation**:
