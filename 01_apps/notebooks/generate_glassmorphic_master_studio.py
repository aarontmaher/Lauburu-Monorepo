...
"""
================================================================================
Lauburu Glassmorphic Master Studio Generator (JupyterLab & Voilà v2026.4)
================================================================================
Canonical SSoT Master Studio Generator implementing:
1. Cyber-Glassmorphism SSoT Theme & Pitch-Black (#020617) Styling Overrides
2. Hero Header Banner with 40 Gbps TB4 PHY DMA (0.27ms RTT) & 82.8 GB Pooled VRAM Badges
3. Master Tabbed Console (9 Tabs) with Feature 1 / Tab 0 as Cyber IDE:
   - Tab 0: 📂 1. Cyber IDE (SeaweedFS Filer + Sandboxed Code Runner)
   - Tab 1: 🌐 2. 14-Port Matrix & Dynamic Multi-View 2x2 Grid Engine (4 Presets)
   - Tab 2: 🖥️ 3. Multi-TUI Suite (Ratatui, Bubble Tea, Textual, ttyd :8088 Streamer)
   - Tab 3: 📡 4. 7-Layer Physical Mesh Radar (Live Socket Probes & Dynamic Caps)
   - Tab 4: 🫀 5. 512Hz Movesense ECG DSP Studio (Pan-Tompkins Algorithm & Plotly/Matplotlib Dual-Renderer)
   - Tab 5: 🥋 6. 955-Node BJJ Spatial Grappling Tree (OPML Parser & Search)
   - Tab 6: ⚔️ 7. CodeClash CoreWar Master Arena (Redcode Duels & 4096-Cell Arena)
   - Tab 7: ⚡ 8. 1-Click Multi-Domain System Optimizer (PyCache Cleaner, Tri-Vault Sync, WireGuard)
   - Tab 8: 📊 9. Real-Time Monorepo AST & Analytics Console (Live AST Scan & LOC Breakdown)\n   - Tab 9: 📓 10. Life Companion (Project Management & Autonomous Logging)
4. Dual-Vault Parity across 01_apps and obsidian_vault
================================================================================
"""
...
APPS_NOTEBOOK = REPO_ROOT / "01_apps" / "notebooks" / "00_lauburu_global_master_project.ipynb"
OBSIDIAN_NOTEBOOK = REPO_ROOT / "obsidian_vault" / "notebooks" / "00_lauburu_global_master_project.ipynb"
OBSIDIAN_MARKDOWN = REPO_ROOT / "obsidian_vault" / "notebooks" / "00_lauburu_global_master_project.md"

OUTPUT_PATHS = [APPS_NOTEBOOK, OBSIDIAN_NOTEBOOK]

# ==============================================================================
# CELL 0: Glassmorphic Hero Header Banner & Pitch-Black Styles
# ==============================================================================
cell_0_markdown = {
    "cell_type": "markdown",
    "id": "cell-md-hero-header",
    "metadata": {},
    "source": [
        "<style>\n",
        "  /* ── 🌌 LAUBURU MASTER DARK/BLACK THEME & GLASSMORPHIC TABS ── */\n",
        ...
        "  }\n",
        "  \n",
        "  /* Master Tab Container Styling */\n",
        "  .jupyter-widgets.p-TabBar, .jupyter-widgets.p-TabBar-content, .widget-tab-bar {\n",
        ...
        "  }\n",
        "  \n",
        "  .jupyter-widgets.p-TabBar-tab, .widget-tab-bar .p-TabBar-tab {\n",
        ...
        "  }\n",
        "  \n",
        "  .jupyter-widgets.p-TabBar-tab:hover, .widget-tab-bar .p-TabBar-tab:hover {\n",
        "    color: #38bdf8 !important;\n",
        "    background: rgba(30, 41, 59, 0.9) !important;\n",
        "    border-color: rgba(56, 189, 248, 0.4) !important;\n",
        "  }\n",
        "  \n",
        "  .jupyter-widgets.p-TabBar-tab.p-mod-current, .widget-tab-bar .p-TabBar-tab.p-mod-current {\n",
        "    background: #020617 !important;\n",
        "    color: #38bdf8 !important;\n",
        ...
        "  }\n",
        "  \n",
        "  .jupyter-widgets.p-TabPanel-tabContents, .widget-tab-contents {\n",
        "    background: #020617 !important;\n",
        "    border: 1px solid #1e293b !important;\n",
        ...
        "</style>\n",
        "\n",
        "<div class=\"glass-card glass-card-glow-cyan\" style=\"margin-bottom: 12px;\">\n",
        "  <div style=\"display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px;\">\n",
        "    <div style=\"display: flex; align-items: center; gap: 14px;\">\n",
        "      <div style=\"width: 44px; height: 44px; border-radius: 12px; background: linear-gradient(135deg, #0284c7 0%, #10b981 100%); display: flex; align-items: center; justify-content: center; font-size: 22px; box-shadow: 0 0 15px rgba(2, 132, 199, 0.4);\">\n",
        "        🌌\n",
        "      </div>\n",
        "      <div>\n",
        ...
        "          Feature 1: Cyber IDE • 14-Port Matrix 2x2 • Multi-TUI • 7-Layer Radar • 512Hz ECG DSP • 955-Node BJJ • CoreWar • Optimizer • AST\n",
        "        </div>\n",
        "      </div>\n",
        "    </div>\n",
        "    <div style=\"display: flex; gap: 8px; flex-wrap: wrap;\">\n",
        "      <span class=\"badge-chip\" style=\"background: #064e3b; color: #6ee7b7; border: 1px solid #10b981;\">\n",
        "        <span class=\"pulse-dot\"></span> 100% OPERATIONAL\n",
        "      </span>\n",
        "      <span class=\"badge-chip\" style=\"background: #1e1b4b; color: #c7d2fe; border: 1px solid #6366f1;\">\n",
        "        ⚡ 40 Gbps TB4 PHY DMA (0.27ms RTT)\n",
        "      </span>\n",
        "      <span class=\"badge-chip\" style=\"background: #3b0764; color: #d8b4fe; border: 1px solid #a855f7;\">\n",
        "        💎 82.8 GB POOLED VRAM\n",
        "      </span>\n",
        "    </div>\n",
        "  </div>\n",
...
# ==============================================================================
# CELL 1: Canonical Master Tabbed Console Code
# ==============================================================================
cell_1_code_text = '''# ─── MASTER TABBED CONSOLE & RUNTIME ENGINE (IDE AS FIRST FEATURE) ───
import sys, os
...
cell_1_code = {
    ...
    "id": "cell-code-master-tabbed-console",
    "metadata": {},
    "outputs": [],
    "source": [line + "\n" for line in cell_1_code_text.split("\n")]
}

notebook_dict = {
    "cells": [cell_0_markdown, cell_1_code],
    "metadata": {
        "kernelspec": {
            "display_name": "🧠 Lauburu Canonical Studio (Python 3.13 - Widgets & DSP)",
            "language": "python",
            "name": "lauburu-notebooks"
        },
        "language_info": {
            "name": "python",
            "version": "3.13.15"
...
def generate_studio():
    print("Generating Lauburu Master Tabbed Studio Notebook...")
    for path in OUTPUT_PATHS:
        path.parent.mkdir(parents=True, exist_ok=True)
        with open(path, "w", encoding="utf-8") as f:
            json.dump(notebook_dict, f, indent=1)
        print(f"  • Generated notebook: {path} ({len(notebook_dict['cells'])} cells)")

    # Also generate Obsidian synchronized Markdown representation
    OBSIDIAN_MARKDOWN.parent.mkdir(parents=True, exist_ok=True)
    md_text = f"""---
...
```
"""
    with open(OBSIDIAN_MARKDOWN, "w", encoding="utf-8") as f:
        f.write(md_text)
    print(f"  • Generated synchronized markdown: {OBSIDIAN_MARKDOWN}")
