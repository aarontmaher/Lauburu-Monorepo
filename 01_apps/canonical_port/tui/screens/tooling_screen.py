...
class ToolingScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        ...
        yield PinnedTabNavBar(active_screen="tooling")
        with ScrollableContainer(id="tooling-container"):
            yield Static(id="ai-watchdog-view")
        ...
        yield DockedShortcutsLegend(active_screen="tooling")
        yield Footer()
