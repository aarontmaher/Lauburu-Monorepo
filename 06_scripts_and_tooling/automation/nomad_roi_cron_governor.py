...
REMOTE_NODES = {
    ...
    "macbook_pro_vault": {
        ...
        "role": "Storage & Compute Vault (16 GB RAM)",
        "icon": "💻"
    },
    "macbook_air": {
        "layer": "L5",
...
DEFAULT_JOBS = [
    {
        ...
        "name": "7-Device Mesh Network Healer & Port Watchdog",
    ...
    {
        "id": "cron_009_cloud_api_quota_manager",
        "name": "Cloud API Quota Manager & Continuous LoRA Distillation",
        "script": str(REPO_ROOT / "06_scripts_and_tooling/automation/cloud_api_quota_manager.py"),
        "args": ["--live"],
        ...
        "rationale": "Maximizes free cloud AI quotas (Gemini, Cloudflare, Julien) and generates 24/7 LoRA distillation datasets. Migrated from naive daemon to adaptive governor."
    }
]
