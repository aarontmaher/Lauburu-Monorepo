...
and canonical storage compliance under /Volumes/Lauburu-Monorepo/data/.
"""
...
CANONICAL_WORKSPACE_ROOT = Path("/Volumes/Lauburu-Monorepo")
CANONICAL_DATA_DIR = CANONICAL_WORKSPACE_ROOT / "data"

# Real Local Filesystem Resolution
_POSSIBLE_ROOTS = [
    Path("/Volumes/Lauburu-Monorepo"),
...
class PetalsMeshShardingCoordinator:
    ...
    def save_sharding_plan(
        ...
        """
        Saves a sharding plan JSON to canonical workspace data storage (/Volumes/Lauburu-Monorepo/data/).
