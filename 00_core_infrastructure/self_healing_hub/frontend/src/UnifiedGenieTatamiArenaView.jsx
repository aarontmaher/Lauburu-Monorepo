...
export default function UnifiedGenieTatamiArenaView() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', paddingBottom: '3rem' }}>
      ...
      {/* INJECTED ORIGINAL LAUBURU AI ARENA (Hacking Game & Nomad Fleet) */}
      <div style={{ height: '500px', width: '100%', border: '1px solid #334155', borderRadius: '12px', overflow: 'hidden', flexShrink: 0 }}>
        <iframe src="/arena_canvas.html" style={{ width: '100%', height: '100%', border: 'none' }} title="Lauburu AI Arena WebGPU Canvas" />
      </div>
