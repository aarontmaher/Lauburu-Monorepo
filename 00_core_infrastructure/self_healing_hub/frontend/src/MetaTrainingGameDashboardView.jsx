...
export default function MetaTrainingGameDashboardView() {
  ...
  const LOCAL_MODEL_OPTIONS = [
    { key: 'hermes_vision_auditor', name: 'Hermes 3 Vision (70B)', badge: '🦅 Hermes 70B', role: 'Visual UI Auditor' },
    { key: 'openclaw_browser_sentinel', name: 'OpenClaw (Browser-Use Sentinel)', badge: '🦀 OpenClaw', role: 'VLM Web Automation' },
