---
name: ai-debate
description: Executes the Tri-Orchestrator Live Agent Debate Protocol (Gemini 3.1 Pro High, Gemini 3.7 Flash High, Kimi Tandem, Qwen 3.8max) to achieve the highest possible decision quality, resolving complex architectural bottlenecks and integrating HuggingFace training features (trl, peft, accelerate) into the localhost:3000 training module.
---
